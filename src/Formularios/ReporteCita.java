...
public class ReporteCita extends javax.swing.JInternalFrame {
    ...
    public ReporteCita() {
        ...
        try {
            ...
            Logger.getLogger(ReporteCita.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void initComponents() {
        ...
        setTitle("Reporte Citas Diarias");
    ...
    private void btnaceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaceptarActionPerformed
        ...
        try {
                    String ruta=sep+"src"+sep+"Reportes"+sep+"CitasDiarias.jrxml";
            //cargamos el reporte
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReporteCita.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReporteCita().setVisible(true);
            }
        });
    }
